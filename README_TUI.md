...
- 🔄 **Background Processing**: Non-blocking AI analysis with real-time progress updates
- 📝 **Auto-Population**: Automatic form filling from AI analysis results
...
- `↑`/`↓`: Navigate commit types and tasks
...
- **JSON Response** containing all fields:
  ```json
  {
    "title": "concise Spanish title (≤50 chars)",
    "commitType": "semantic release type",
    "description": "exhaustive technical description (≥150 words)",
...
- 📋 "Obteniendo commits desde la última versión..."
- 🏷️ "Obteniendo última etiqueta del repositorio..."
- 📊 "Analizando commits desde la última versión..."
- 🔍 "Extrayendo IDs de tareas de Monday.com..."
- 📄 "Generando documento estructurado para versión..."
- 🤖 "Enviando documento a Google Gemini API..."
...
### Enhanced Features
- ✅ **Interactive TUI** instead of command-line prompts
- ✅ **Real-time AI Analysis** with progress feedback
- ✅ **Dual Analysis Modes** (multi-call vs comprehensive)
- ✅ **Background Processing** for responsive UI
- ✅ **Advanced Task Management** with visual selection
- ✅ **Auto-form Population** from AI analysis
- ✅ **Improved Error Handling** with graceful recovery

### Full Compatibility
- ✅ **Same API Integrations** (Monday.com + Gemini)
- ✅ **Compatible Commit Format** with original
- ✅ **Same Configuration System** (.env file)
- ✅ **Same Release Notes Structure** and content
- ✅ **CLI Command Compatibility** for automation

### Performance Improvements
- ⚡ **Parallel Processing** for faster AI analysis
- ⚡ **Background Operations** for responsive interface
- ⚡ **Efficient Git Operations** with native Git2 library
