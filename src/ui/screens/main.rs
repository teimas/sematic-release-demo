...
pub fn draw_main_screen(
    ...
    if let Some(status) = git_status {
        ...
        if !status.staged.is_empty() {
            content_lines.push(Line::from(vec![
                ...
                Span::styled(
                    format!("Staged files ({}): Ready to commit", status.staged.len()),
            ...
            if status.staged.len() > 5 {
                content_lines.push(Line::from(vec![Span::styled(
                    format!("   ... and {} more", status.staged.len() - 5),
        ...
        if !status.modified.is_empty() {
            content_lines.push(Line::from(vec![
                ...
                Span::styled(
                    format!(
                        "Modified files ({}): Use 'git add' to stage",
                        status.modified.len()
                    ),
            ...
            if status.modified.len() > 3 {
                content_lines.push(Line::from(vec![Span::styled(
                    format!("   ... and {} more", status.modified.len() - 3),
                    Style::default().fg(Color::Gray),
                )]));
            }
        }
        ...
        if !status.untracked.is_empty() {
            content_lines.push(Line::from(vec![
                ...
                Span::styled(
                    format!("Untracked files ({}): New files", status.untracked.len()),
            ...
            if status.untracked.len() > 3 {
                content_lines.push(Line::from(vec![Span::styled(
                    format!("   ... and {} more", status.untracked.len() - 3),
                    Style::default().fg(Color::Gray),
                )]));
            }
        }
        ...
        content_lines.push(Line::from(vec![
            ...
            Span::styled(
                "Repository Status: Not available (not in git repo?)",
    ...
    content_lines.extend(vec![
        ...
        Line::from(vec![
            ...
            Span::styled(
                ": Navigate between tabs and fields",
        ...
        Line::from(vec![
            ...
            Span::styled(
                ": Navigate between fields (auto-edit mode)",
                Style::default().fg(Color::White),
            ),
        ]),
        Line::from(vec![
            ...
            Span::styled(
                ": Add new line in multiline fields",
                Style::default().fg(Color::White),
            ),
        ]),
        Line::from(vec![
            ...
            Span::styled(
                ": Comprehensive AI analysis (JSON response)",
                Style::default().fg(Color::White),
            ),
        ]),
        Line::from(vec![
        ...
        Line::from(vec![
            Span::styled("🚀 ", Style::default().fg(Color::Green)),
            Span::styled(
                "Press Tab to navigate to Commit screen to get started!",
                Style::default()
                    .fg(Color::Green)
                    .add_modifier(Modifier::BOLD),
            ),
